...
export class EvidenceGenerator {
  ...
  generateTradeRemedyReport(data: {
    ...
    // Dumping Analysis
    this.addSection('Dumping Analysis', [
    ...
    if (data.estimatedRevenueLoss) {
      this.addSection('Estimated Injury Impact', [
    ...
    // Causation
    this.addSection('Causation Analysis', [data.causation]);

    // Recommended Measures
    this.addSection('Recommended Trade Remedy Measures', [
    ...
    // Footer
    this.addFooter('This report is generated by TradeNest Trade Remedy Workbench');
  ...
  generateExecutiveIntelligenceReport(data: {
    ...
    // Footer
    this.addFooter('Executive Intelligence Report - TradeNest Platform');
