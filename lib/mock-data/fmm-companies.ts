...
export const FMM_COMPANIES: CompanyTemplate[] = [
  ...
  { name: 'AsiaPac Metal Trading Sdn Bhd', sector: 'Steel & Metals', country: 'Malaysia', type: 'both' },
  ...
  { name: 'Peninsula Iron & Steel Sdn Bhd', sector: 'Steel & Metals', country: 'Malaysia', type: 'both' },
  { name: 'Johor Metal Industries Sdn Bhd', sector: 'Steel & Metals', country: 'Malaysia', type: 'importer' },
  { name: 'Malaysian Steel Corp Berhad', sector: 'Steel & Metals', country: 'Malaysia', type: 'both' },
  { name: 'Northern Metal Works Sdn Bhd', sector: 'Steel & Metals', country: 'Malaysia', type: 'importer' },
  { name: 'Integrated Steel Solutions Sdn Bhd', sector: 'Steel & Metals', country: 'Malaysia', type: 'both' },
  ...
  { name: 'Metro Metal Supplies Sdn Bhd', sector: 'Steel & Metals', country: 'Malaysia', type: 'both' },
  ...
  { name: 'ElectroNusa Manufacturing Sdn Bhd', sector: 'Electronics & Electrical', country: 'Malaysia', type: 'both' },
  { name: 'Penang Semiconductor Industries Sdn Bhd', sector: 'Electronics & Electrical', country: 'Malaysia', type: 'both' },
  ...
  { name: 'Klang Valley Electronics Sdn Bhd', sector: 'Electronics & Electrical', country: 'Malaysia', type: 'both' },
  { name: 'Integrated Components Malaysia Sdn Bhd', sector: 'Electronics & Electrical', country: 'Malaysia', type: 'importer' },
  { name: 'Asia Telecom Solutions Sdn Bhd', sector: 'Electronics & Electrical', country: 'Malaysia', type: 'both' },
  { name: 'Power Systems Malaysia Sdn Bhd', sector: 'Electronics & Electrical', country: 'Malaysia', type: 'importer' },
  { name: 'Digital Manufacturing Solutions Sdn Bhd', sector: 'Electronics & Electrical', country: 'Malaysia', type: 'both' },
  { name: 'Johor Tech Components Sdn Bhd', sector: 'Electronics & Electrical', country: 'Malaysia', type: 'importer' },
  { name: 'Malaysian LED Industries Sdn Bhd', sector: 'Electronics & Electrical', country: 'Malaysia', type: 'both' },
  { name: 'Northern Electronics Assembly Sdn Bhd', sector: 'Electronics & Electrical', country: 'Malaysia', type: 'importer' },
  { name: 'Smart Device Manufacturing Sdn Bhd', sector: 'Electronics & Electrical', country: 'Malaysia', type: 'both' },
  ...
  { name: 'PolymerTech Industries Sdn Bhd', sector: 'Chemicals & Petrochemicals', country: 'Malaysia', type: 'both' },
  { name: 'Malaysian Petrochemical Corp Berhad', sector: 'Chemicals & Petrochemicals', country: 'Malaysia', type: 'both' },
  { name: 'Specialty Chemicals Malaysia Sdn Bhd', sector: 'Chemicals & Petrochemicals', country: 'Malaysia', type: 'importer' },
  { name: 'Bintulu Petrochemical Industries Sdn Bhd', sector: 'Chemicals & Petrochemicals', country: 'Malaysia', type: 'both' },
  { name: 'Industrial Chemicals Suppliers Sdn Bhd', sector: 'Chemicals & Petrochemicals', country: 'Malaysia', type: 'importer' },
  { name: 'Asia Polymer Solutions Sdn Bhd', sector: 'Chemicals & Petrochemicals', country: 'Malaysia', type: 'both' },
  { name: 'Klang Chemical Trading Sdn Bhd', sector: 'Chemicals & Petrochemicals', country: 'Malaysia', type: 'importer' },
  { name: 'Southern Petrochemical Sdn Bhd', sector: 'Chemicals & Petrochemicals', country: 'Malaysia', type: 'both' },
  { name: 'Malaysian Resins Manufacturing Sdn Bhd', sector: 'Chemicals & Petrochemicals', country: 'Malaysia', type: 'importer' },
  { name: 'Integrated Chemical Solutions Sdn Bhd', sector: 'Chemicals & Petrochemicals', country: 'Malaysia', type: 'both' },
  ...
  { name: 'AgroTrade Malaysia Sdn Bhd', sector: 'Food & Beverage', country: 'Malaysia', type: 'both' },
  { name: 'Malaysian Food Industries Berhad', sector: 'Food & Beverage', country: 'Malaysia', type: 'importer' },
  { name: 'Premium Beverages Malaysia Sdn Bhd', sector: 'Food & Beverage', country: 'Malaysia', type: 'both' },
  ...
  { name: 'Asia Pacific Food Trading Sdn Bhd', sector: 'Food & Beverage', country: 'Malaysia', type: 'both' },
  ...
  { name: 'Peninsula Food Solutions Sdn Bhd', sector: 'Food & Beverage', country: 'Malaysia', type: 'both' },

  // =====================================================
  // TEXTILES & APPAREL (6 companies) - Labor-intensive
  // =====================================================
  { name: 'FabricCraft Industries Sdn Bhd', sector: 'Textiles & Apparel', country: 'Malaysia', type: 'both' },
  { name: 'GarmentPro Malaysia Sdn Bhd', sector: 'Textiles & Apparel', country: 'Malaysia', type: 'importer' },
  { name: 'Malaysian Textile Mills Berhad', sector: 'Textiles & Apparel', country: 'Malaysia', type: 'both' },
  { name: 'Asia Fabric Imports Sdn Bhd', sector: 'Textiles & Apparel', country: 'Malaysia', type: 'importer' },
  { name: 'Apparel Manufacturing Solutions Sdn Bhd', sector: 'Textiles & Apparel', country: 'Malaysia', type: 'both' },
  ...
  { name: 'MotorParts Asia Sdn Bhd', sector: 'Automotive & Parts', country: 'Malaysia', type: 'both' },
  { name: 'Malaysian Auto Assembly Berhad', sector: 'Automotive & Parts', country: 'Malaysia', type: 'importer' },
  { name: 'Precision Auto Parts Sdn Bhd', sector: 'Automotive & Parts', country: 'Malaysia', type: 'both' },
